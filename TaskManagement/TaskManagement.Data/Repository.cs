...
namespace TaskManagement.Data
{
    ...
    where TEntity : class, IEntity<TKey>
    {
        ...
        public virtual TEntity GetById(TKey id, string includeProperties = null)
        {
            IQueryable<TEntity> query = _dbSet;
        ...
        public virtual (IList<TEntity> data, int total, int totalDisplay) Get(
            ...
            string includeProperties = "", int pageIndex = 1, int pageSize =20, bool isTrackingOff = false)
        {
            IQueryable<TEntity> query = _dbSet;
        ...
        public virtual (IList<TEntity> data, int total, int totalDisplay) GetDynamic(
            Expression<Func<TEntity, bool>> filter = null,
            string orderBy = null,
            string includeProperties = null, int pageIndex = 1, int pageSize = 20, bool isTrackingOff = false)
        {
            IQueryable<TEntity> query = _dbSet;
            var total = query.Count();
